...
Tops = Frame(root, bg='Teal', bd=25, pady=20, relief=GROOVE)
Tops.pack(side=TOP)
...
ReceiptCal_Function = Frame(root, bg='teal', bd=10, relief=GROOVE)
ReceiptCal_Function.pack(side=LEFT)

Buttons_Function = Frame(ReceiptCal_Function, bg='teal', bd=3, relief=GROOVE)
Buttons_Function.pack(side=TOP)

Calculator_Function = Frame(ReceiptCal_Function, bg='black', bd=6, relief=GROOVE)
Calculator_Function.pack(side=BOTTOM)

Receipt_Function = Frame(ReceiptCal_Function, bg='black', bd=4, relief=GROOVE)
Receipt_Function.pack(side=BOTTOM)

MenuFrame = Frame(root, bg='teal', bd=32, relief=GROOVE)
MenuFrame.pack(side=RIGHT)
Total_Function = Frame(MenuFrame, bg='teal', bd=4)
Total_Function.pack(side=BOTTOM)
Drinks_Function = Frame(MenuFrame,bg='teal',bd=4)
Drinks_Function.pack(side=TOP)


Drinks_Function = Frame(MenuFrame, bg='teal', bd=4, relief=GROOVE)
Drinks_Function.pack(side=LEFT)
Food_Function = Frame(MenuFrame, bg='teal', bd=4, relief=GROOVE)
...
def Receipt():
    ...
    textReceipt.insert(END, 'Coke:\t\t\t\t\t' + cobra.get()+'\n')
    textReceipt.insert(END, 'Fried Chicken:\t\t\t\t\t' + fried_chicken.get()+'\n')
    textReceipt.insert(END, 'Perry Perry:\t\t\t\t\t' + kare_kare.get()+'\n')
    textReceipt.insert(END, 'Crispy Chips:\t\t\t\t\t' + crispy_pata.get()+'\n')
    textReceipt.insert(END, 'Shwarma:\t\t\t\t\t' + sinigang_baboy.get()+'\n')
    textReceipt.insert(END, 'Spagetthi:\t\t\t\t\t' + sinigang_hipon.get()+'\n')
    textReceipt.insert(END, 'Barbeque:\t\t\t\t\t' + bicol_express.get()+'\n')
    textReceipt.insert(END, 'Asparagus Lasagna:\t\t\t\t\t' + asparagus_tofu.get()+'\n')
    textReceipt.insert(END, 'Chicken Tikka:\t\t\t\t\t' + chicken_sisig.get()+'\n')
...
FriedChicken = Checkbutton(Food_Function,text="Fried Chicken\t\t\t ",variable=variable9,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='teal',command=foodsFriedChicken).grid(row=0,sticky=W)
KareKare = Checkbutton(Food_Function,text="Perry Perry",variable=variable10,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='teal',command=foodsKareKare).grid(row=1,sticky=W)
CrispyPata = Checkbutton(Food_Function,text="Crispy Chips",variable=variable11,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='teal',command=foodsCrispyPata).grid(row=2,sticky=W)
SinigangBaboy = Checkbutton(Food_Function,text="Shwarma ",variable=variable12,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='teal',command=foodsSinigangBaboy).grid(row=3,sticky=W)
SinigangHipon = Checkbutton(Food_Function,text="Spagetthi ",variable=variable13,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='teal',command=foodsSinigangHipon).grid(row=4,sticky=W)
BicolExpress = Checkbutton(Food_Function,text="Barbeque ",variable=variable14,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='teal',command=foodsBicolExpress).grid(row=5,sticky=W)
AsparagusTofu = Checkbutton(Food_Function,text="Asparagus Lasagna ",variable=variable15,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='teal',command=foodsAsparagusTofu).grid(row=6,sticky=W)
ChickenSisig = Checkbutton(Food_Function,text="Chicken Tikka ",variable=variable16,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='teal',command=foodsChickenSisig).grid(row=7,sticky=W)
...
# ToTal Cost
lblTotalofDrinks=Label(Total_Function,font=('arial',14,'bold'),text='Total of Drinks\t',bg='teal',fg='black',justify=CENTER)
...
lblTotalofFood=Label(Total_Function,font=('arial',14,'bold'),text='Total of Foods  ',bg='teal',fg='black',justify=CENTER)
...
lblServiceCharge=Label(Total_Function,font=('arial',14,'bold'),text='Service Charge',bg='teal',fg='black',justify=CENTER)
...
lblPaidTax=Label(Total_Function,font=('arial',14,'bold'),text='\tPaid Tax',bg='teal',bd=7,fg='black',justify=CENTER)
...
lblSubTotal=Label(Total_Function,font=('arial',14,'bold'),text='\tSub Total',bg='teal',bd=7,fg='black',justify=CENTER)
...
lblTotalCost=Label(Total_Function,font=('arial',14,'bold'),text='\tTotal',bg='teal',bd=7,fg='black',justify=CENTER)
...
# BUTTONS
buttonTotal=Button(Buttons_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='Total',bg='black',command=TotalofUnit).grid(row=0,column=0)
buttonReceipt=Button(Buttons_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='Receipt',bg='black',command=Receipt).grid(row=0,column=1)
buttonReset=Button(Buttons_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='Reset',bg='black',command=Reset).grid(row=0,column=2)
buttonExit=Button(Buttons_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='Exit',bg='black',command=iExit).grid(row=0,column=3)
...
# CALCULATOR BUTTONS
button7=Button(Calculator_Function, padx=16, pady=1, bd=7, fg='black', font=('arial', 12, 'bold'), width=4, text='7',bg='black',command=lambda:btnClick(7)).grid(row=2,column=0)
button8=Button(Calculator_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='8',bg='black',command=lambda:btnClick(8)).grid(row=2,column=1)
button9=Button(Calculator_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='9',bg='black',command=lambda:btnClick(9)).grid(row=2,column=2)
buttonAdd=Button(Calculator_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='+',bg='black',command=lambda:btnClick('+')).grid(row=2,column=3)

button4=Button(Calculator_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='4',bg='black',command=lambda:btnClick(4)).grid(row=3,column=0)
button5=Button(Calculator_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='5',bg='black',command=lambda:btnClick(5)).grid(row=3,column=1)
button6=Button(Calculator_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='6',bg='black',command=lambda:btnClick(6)).grid(row=3,column=2)
buttonSub=Button(Calculator_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='-',bg='black',command=lambda:btnClick('-')).grid(row=3,column=3)

button1=Button(Calculator_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='1',bg='black',command=lambda:btnClick(1)).grid(row=4,column=0)
button2=Button(Calculator_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='2',bg='black',command=lambda:btnClick(2)).grid(row=4,column=1)
button3=Button(Calculator_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='3',bg='black',command=lambda:btnClick(3)).grid(row=4,column=2)
buttonMulti=Button(Calculator_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='*',bg='black',command=lambda:btnClick('*')).grid(row=4,column=3)

button0=Button(Calculator_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='0',bg='black',command=lambda:btnClick(0)).grid(row=5,column=0)
buttonClear=Button(Calculator_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='C',bg='black',command=btnClear).grid(row=5,column=1)
buttonEqual=Button(Calculator_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='=',bg='black',command=btnEquals).grid(row=5,column=2)
buttonDiv=Button(Calculator_Function,padx=16,pady=1,bd=7,fg='black',font=('arial',12,'bold'),width=4,text='/',bg='black',command=lambda:btnClick('/')).grid(row=5,column=3)
